      ...
      <div className="section-container">
        ...
        <FooterSection delay={0.1}>
          <div className="flex flex-col md:flex-row justify-between items-center standard-gap-small standard-mb-small border-b border-[var(--border-white-light)]">
            ...
            {/* Right: Social Media Icons - only render when link is non-empty */}
            <div className="flex standard-gap-small pb-2 sm:pb-3">
            {settings.social.facebook?.trim() && (
              <SocialIcon href={settings.social.facebook.trim()} ariaLabel="Visit our Facebook page">
            ...
            {settings.social.instagram?.trim() && (
              <SocialIcon href={settings.social.instagram.trim()} ariaLabel="Visit our Instagram page">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            {settings.social.pinterest?.trim() && (
              <SocialIcon href={settings.social.pinterest.trim()} ariaLabel="Visit our Pinterest page">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
