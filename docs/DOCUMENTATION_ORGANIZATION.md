...
All documentation files are organized in the `docs/` folder for easy access and maintenance.
...
- `README.md` - Project overview and quick start (stays in root - standard practice)
