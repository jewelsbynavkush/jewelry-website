...
**Note:** This report consolidates content from previous backend audit reports.
...
11. ✅ `POST /api/cart` - Add item to cart
12. ✅ `DELETE /api/cart` - Clear cart
13. ✅ `PATCH /api/cart/[itemId]` - Update item quantity
14. ✅ `DELETE /api/cart/[itemId]` - Remove item

#### Order APIs (4 endpoints)
15. ✅ `POST /api/orders` - Create order
16. ✅ `GET /api/orders` - List user orders
17. ✅ `GET /api/orders/[orderId]` - Get order details
18. ✅ `PATCH /api/orders/[orderId]` - Update order status (admin)
19. ✅ `POST /api/orders/[orderId]/cancel` - Cancel order

#### User Profile APIs (7 endpoints)
20. ✅ `GET /api/users/profile` - Get user profile
21. ✅ `PATCH /api/users/profile` - Update user profile
22. ✅ `GET /api/users/addresses` - List addresses
23. ✅ `POST /api/users/addresses` - Add address
24. ✅ `PATCH /api/users/addresses/[addressId]` - Update address
25. ✅ `DELETE /api/users/addresses/[addressId]` - Delete address
26. ✅ `PATCH /api/users/password` - Change password

#### Product APIs (2 endpoints)
27. ✅ `GET /api/products` - List products
28. ✅ `GET /api/products/[slug]` - Get product by slug

#### Category APIs (1 endpoint)
29. ✅ `GET /api/categories` - List active categories

#### Inventory APIs (4 endpoints)
30. ✅ `GET /api/inventory/[productId]` - Get inventory status
31. ✅ `POST /api/inventory/[productId]/restock` - Restock product (admin)
32. ✅ `GET /api/inventory/logs` - Get inventory logs (admin)
33. ✅ `GET /api/inventory/low-stock` - Get low stock alerts (admin)

#### Other APIs (3 endpoints)
34. ✅ `GET /api/site-settings` - Get site settings
35. ✅ `POST /api/contact` - Submit contact form
36. ✅ `GET /api/health` - Health check
37. ✅ `GET /api/docs` - API documentation
38. ✅ `GET /api/content/[page]` - Get page content
...
8. ✅ `/auth/logout` - POST
9. ✅ `/auth/refresh` - POST
10. ✅ `/auth/verify-email` - POST
11. ✅ `/auth/resend-otp` - POST
12. ✅ `/auth/resend-email-otp` - POST
13. ✅ `/auth/reset-password` - POST
14. ✅ `/auth/reset-password/confirm` - POST
15. ✅ `/users/profile` - GET, PATCH
16. ✅ `/users/addresses` - GET, POST
17. ✅ `/users/addresses/{addressId}` - PATCH, DELETE
18. ✅ `/users/password` - PATCH
19. ✅ `/products` - GET
20. ✅ `/products/{slug}` - GET
21. ✅ `/categories` - GET
22. ✅ `/content/{page}` - GET
23. ✅ `/site-settings` - GET
24. ✅ `/contact` - POST
25. ✅ `/health` - GET
26. ✅ `/inventory/{productId}` - GET
27. ✅ `/inventory/{productId}/restock` - POST
28. ✅ `/inventory/logs` - GET
29. ✅ `/inventory/low-stock` - GET
