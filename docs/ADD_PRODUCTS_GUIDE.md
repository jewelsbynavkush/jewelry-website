...
db.products.insertOne({
  ...
  alt: "Gold earrings",
  inventory: {
    quantity: 5,  // ← Initial stock: 5 earrings
    reservedQuantity: 0,
    trackQuantity: true,
    allowBackorder: false,
    lowStockThreshold: 2,
...
async function addProducts() {
  try {
    ...
    await necklace.save();
    console.log('✅ Necklace added:', necklace.sku);
    ...
    await earrings.save();
    console.log('✅ Earrings added:', earrings.sku);
...
## ✅ **Step-by-Step: Adding Your First Products**
...
```javascript
primaryImage: "/images/necklace.jpg"  // ✅ Correct
primaryImage: "images/necklace.jpg"   // ❌ Missing leading slash
```
